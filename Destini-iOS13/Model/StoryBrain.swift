...
struct StoryBrain {
    ...
    var currStoryIndex = 0
    
    
    func getStory()-> Story {
        return stories[currStoryIndex]
    }
    
    mutating func choiceMade(choice: String) {
        let currentStory = stories[currStoryIndex]
        
        if choice == currentStory.choice1 {
            currStoryIndex = currentStory.choice1Destination
        } else {
            currStoryIndex = currentStory.choice2Destination
        }
    }
}
